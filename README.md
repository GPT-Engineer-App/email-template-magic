...
**Project**: email-template-magic 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Given these 2 images, return an html template for email marketing, resembling the exact structure. use placeholders images for the html images. Include the css inside the html template. 
...
```sh
git clone https://github.com/GPT-Engineer-App/email-template-magic.git
cd email-template-magic
npm i
